...
export function SiteFooter() {
  return (
    <footer className="mt-24 border-t border-glass-border bg-glass backdrop-blur-md relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid gap-12 md:grid-cols-4 relative z-10">
        <div className="md:col-span-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-display text-2xl font-bold text-heading leading-none">Dienstleister Ejupi</p>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-foreground/70">
            <li className="flex gap-3 items-start group">
              <Phone className="size-4 mt-0.5 shrink-0 text-primary group-hover:text-heading transition-colors" />
              <a href="tel:+4915201600202" className="hover:text-heading transition-colors">01520 1600 202</a>
            </li>
            <li className="flex gap-3 items-start group">
              <Mail className="size-4 mt-0.5 shrink-0 text-primary group-hover:text-heading transition-colors" />
              <a href="mailto:ejupiburim@googlemail.com" className="hover:text-heading transition-colors break-all">
                ejupiburim@googlemail.com
              </a>
            </li>
            <li className="flex gap-3 items-start group">
              <MapPin className="size-4 mt-0.5 shrink-0 text-primary group-hover:text-heading transition-colors" />
      ...
      <div className="border-t border-glass-border relative z-10" style={{ backgroundColor: "var(--footer-bar)" }}>
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row gap-3 justify-between items-center text-xs text-foreground/50">
          ...
          <div className="flex gap-6">
            <Link to="/impressum" className="hover:text-heading transition-colors">Impressum</Link>
            <Link to="/datenschutz" className="hover:text-heading transition-colors">Datenschutz</Link>
          </div>
        </div>
      </div>
    </footer>
