  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 relative overflow-hidden">
      <div className="max-w-md text-center glass-panel p-12 rounded-3xl relative z-10">
        <h1 className="text-7xl font-bold text-heading drop-shadow-md">404</h1>
        <h2 className="mt-4 text-xl font-semibold text-heading">Seite nicht gefunden</h2>
        ...
        <div className="mt-8">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-xl bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_30px_rgba(16,185,129,0.5)] transition-all"
          >
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center glass-panel p-12 rounded-3xl">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-xl border border-glass-border bg-glass-strong px-6 py-3 text-sm font-semibold text-heading hover:bg-foreground/10 transition-colors"
          >
            Zur Startseite
          </a>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [
        ...
        {
          title:
            "Dienstleister Ejupi — Garten- & Landschaftsbau in Kirchheim",
        },
        {
          name: "description",
          content:
        ...
        {
          property: "og:title",
          content: "Dienstleister Ejupi — Garten- & Landschaftsbau",
        },
        {
          property: "og:description",
          content:
            "Service rund ums Häusle — Garten- und Landschaftsbau in Kirchheim unter Teck.",
        },
...
function AmbientBackground() {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10 bg-background hidden md:block">
