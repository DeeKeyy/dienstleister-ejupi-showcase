...
function ImpressumPage() {
  return (
    <section className="px-6 py-20 max-w-3xl mx-auto prose-sm">
      <h1 className="font-display text-4xl mb-8 text-heading">Impressum</h1>
      <div className="space-y-6 text-sm leading-relaxed text-foreground/70">
        <div>
          <p className="font-semibold text-heading">Angaben gemäß § 5 TMG</p>
          <p className="mt-2">
        ...
        <div>
          <p className="font-semibold text-heading">Kontakt</p>
          <p className="mt-2">
